...
const HeroContent = () => {
    ...
    <p data-aos="fade-left" data-aos-delay='150' className=" text-sm md:text-base text-white text-opacity-60">
    ...
    <div className="mt-8 flex items-center space-x-4">
        <button data-aos="zoom-in" data-aos-delay='300' className="md:px12 md:py-2.5 px-6 py-1.5 text-white font-semibold text-sm md:text-lg transition-all duration-200 rounded-lg bg-green-700 hover:bg-green-900 hover:underline">Get Started</button>
        <button data-aos="zoom-in" data-aos-delay='450' className="md:px12 md:py-2.5 px-6 py-1.5 text-white font-semibold text-sm md:text-lg transition-all duration-200 rounded-lg bg-yellow-700 hover:bg-yellow-900 hover:underline">Learn More</button>
    </div>
    {/* stars */}
